 ...
 * </p>
 * <ul>
 *   <li>{@link io.github.abelgomez.asyncapi.i40.impl.BrokerImpl#getName <em>Name</em>}</li>
...
public class BrokerImpl extends MinimalEObjectImpl.Container implements Broker {
	...
	protected EClass eStaticClass() {
		return I40Package.Literals.BROKER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, I40Package.BROKER__NAME, oldName, name));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, I40Package.BROKER__URL, oldUrl, url));
	}
	...
	public void setProtocol(Protocol newProtocol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, I40Package.BROKER__PROTOCOL, oldProtocol, protocol));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, I40Package.BROKER__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case I40Package.BROKER__NAME:
				return getName();
			case I40Package.BROKER__URL:
				return getUrl();
			case I40Package.BROKER__PROTOCOL:
				return getProtocol();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case I40Package.BROKER___PUBLISH:
				publish();
				return null;
			case I40Package.BROKER___SUBSCRIBE:
				subscribe();
				return null;
		}
