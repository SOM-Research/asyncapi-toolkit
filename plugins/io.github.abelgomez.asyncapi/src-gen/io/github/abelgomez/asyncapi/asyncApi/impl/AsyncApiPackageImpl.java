...
public class AsyncApiPackageImpl extends EPackageImpl implements AsyncApiPackage
{
   ...
   * @generated
   */
  private EEnum messageIdentifierEEnum = null;
   ...
   */
  @Override
  public EAttribute getServer_IsMonitored()
  {
   ...
   */
  @Override
  public EAttribute getMessage_Identifier()
  {
   ...
   */
  @Override
  public EReference getSla_GuaranteeTerms()
  {
   ...
   */
  @Override
  public EAttribute getGuaranteeTerm_Name()
  {
   ...
   */
  @Override
  public EEnum getMessageIdentifier()
  {
    return messageIdentifierEEnum;
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(serverEClass, SERVER__IS_MONITORED);
    ...
    createEAttribute(messageEClass, MESSAGE__IDENTIFIER);
    ...
    createEReference(slaEClass, SLA__GUARANTEE_TERMS);

    guaranteeTermEClass = createEClass(GUARANTEE_TERM);
    createEAttribute(guaranteeTermEClass, GUARANTEE_TERM__NAME);
    ...
    messageIdentifierEEnum = createEEnum(MESSAGE_IDENTIFIER);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getServer_IsMonitored(), this.getBoolean(), "isMonitored", null, 0, 1, Server.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getMessage_Identifier(), this.getMessageIdentifier(), "identifier", null, 0, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSla_GuaranteeTerms(), this.getGuaranteeTerm(), null, "guaranteeTerms", null, 0, -1, Sla.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(guaranteeTermEClass, GuaranteeTerm.class, "GuaranteeTerm", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getGuaranteeTerm_Name(), ecorePackage.getEString(), "name", null, 0, 1, GuaranteeTerm.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(qoSMetricTypeEEnum, QoSMetricType.PERIOD);
    ...
    addEEnumLiteral(qoSMetricTypeEEnum, QoSMetricType.MEMORY_CAPACITY);
    ...
    addEEnumLiteral(qoSMetricTypeEEnum, QoSMetricType.TIME_TO_FAIL);
    addEEnumLiteral(qoSMetricTypeEEnum, QoSMetricType.TIME_TO_REPAIR);
    ...
    initEEnum(messageIdentifierEEnum, MessageIdentifier.class, "MessageIdentifier");
    addEEnumLiteral(messageIdentifierEEnum, MessageIdentifier.NONE);
    addEEnumLiteral(messageIdentifierEEnum, MessageIdentifier.GENERATED);
    addEEnumLiteral(messageIdentifierEEnum, MessageIdentifier.MD5);
    addEEnumLiteral(messageIdentifierEEnum, MessageIdentifier.SHA256);
