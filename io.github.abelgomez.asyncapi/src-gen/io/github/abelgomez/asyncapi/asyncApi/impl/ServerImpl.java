 ...
 * @generated
 */
public class ServerImpl extends AbstractServerImpl implements Server
{
  /**
  ...
  public EList<AbstractVariable> getVariables()
  {
    if (variables == null)
    {
      variables = new EObjectContainmentEList<AbstractVariable>(AbstractVariable.class, this, AsyncApiPackage.SERVER__VARIABLES);
    }
    return variables;
  }
