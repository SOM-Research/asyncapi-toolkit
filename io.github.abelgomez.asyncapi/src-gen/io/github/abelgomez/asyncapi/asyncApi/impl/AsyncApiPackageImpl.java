...
public class AsyncApiPackageImpl extends EPackageImpl implements AsyncApiPackage
{
   ...
   * @generated
   */
  private EClass abstractInfoEClass = null;
   ...
   * @generated
   */
  private EClass abstractContactEClass = null;
   ...
   * @generated
   */
  private EClass abstractServerEClass = null;
   ...
   * @generated
   */
  private EClass abstractTopicEClass = null;
   ...
   */
  @Override
  public EClass getAbstractInfo()
  {
    return abstractInfoEClass;
  }
   ...
   */
  @Override
  public EClass getAbstractContact()
  {
    return abstractContactEClass;
  }
   ...
   */
  @Override
  public EClass getAbstractTopic()
  {
    return abstractTopicEClass;
  }
   ...
   */
  @Override
  public EAttribute getSchema_Summary()
  {
   ...
   */
  @Override
  public EReference getSchema_Schemas()
  {
   ...
   */
  @Override
  public EReference getSchema_Payloads()
  {
   ...
   */
  @Override
  public EReference getComponent_Schemas()
  {
  ...
  public void createPackageContents()
  {
    ...
    abstractInfoEClass = createEClass(ABSTRACT_INFO);
    ...
    abstractContactEClass = createEClass(ABSTRACT_CONTACT);
    ...
    abstractServerEClass = createEClass(ABSTRACT_SERVER);
    ...
    abstractTopicEClass = createEClass(ABSTRACT_TOPIC);
    ...
    createEAttribute(schemaEClass, SCHEMA__SUMMARY);
    ...
    createEReference(schemaEClass, SCHEMA__SCHEMAS);
    createEReference(schemaEClass, SCHEMA__PAYLOADS);
    createEAttribute(schemaEClass, SCHEMA__ENUM);

    abstractComponentEClass = createEClass(ABSTRACT_COMPONENT);

    componentEClass = createEClass(COMPONENT);
    createEReference(componentEClass, COMPONENT__SCHEMAS);
  ...
  public void initializePackageContents()
  {
    ...
    infoEClass.getESuperTypes().add(this.getAbstractInfo());
    contactEClass.getESuperTypes().add(this.getAbstractContact());
    licenseEClass.getESuperTypes().add(this.getAbstractLicense());
    serverEClass.getESuperTypes().add(this.getAbstractServer());
    variableEClass.getESuperTypes().add(this.getAbstractVariable());
    topicEClass.getESuperTypes().add(this.getAbstractTopic());
    ...
    referenceEClass.getESuperTypes().add(this.getAbstractInfo());
    referenceEClass.getESuperTypes().add(this.getAbstractContact());
    referenceEClass.getESuperTypes().add(this.getAbstractLicense());
    referenceEClass.getESuperTypes().add(this.getAbstractServer());
    referenceEClass.getESuperTypes().add(this.getAbstractVariable());
    referenceEClass.getESuperTypes().add(this.getAbstractTopic());
    referenceEClass.getESuperTypes().add(this.getAbstractMessage());
    referenceEClass.getESuperTypes().add(this.getAbstractSchema());
    referenceEClass.getESuperTypes().add(this.getAbstractComponent());
    ...
    initEReference(getAsyncAPI_Info(), this.getAbstractInfo(), null, "info", null, 0, 1, AsyncAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAsyncAPI_Servers(), this.getAbstractServer(), null, "servers", null, 0, -1, AsyncAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAsyncAPI_Topics(), this.getAbstractTopic(), null, "topics", null, 0, -1, AsyncAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAsyncAPI_Components(), this.getAbstractComponent(), null, "components", null, 0, -1, AsyncAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(abstractInfoEClass, AbstractInfo.class, "AbstractInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEReference(getInfo_Contact(), this.getAbstractContact(), null, "contact", null, 0, 1, Info.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getInfo_License(), this.getAbstractLicense(), null, "license", null, 0, 1, Info.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(abstractContactEClass, AbstractContact.class, "AbstractContact", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEClass(abstractLicenseEClass, AbstractLicense.class, "AbstractLicense", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEClass(abstractServerEClass, AbstractServer.class, "AbstractServer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEReference(getServer_Variables(), this.getAbstractVariable(), null, "variables", null, 0, -1, Server.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(abstractTopicEClass, AbstractTopic.class, "AbstractTopic", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEAttribute(getSchema_Summary(), ecorePackage.getEString(), "summary", null, 0, 1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSchema_Schemas(), this.getAbstractSchema(), null, "schemas", null, 0, -1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSchema_Payloads(), this.getAbstractSchema(), null, "payloads", null, 0, -1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getComponent_Schemas(), this.getAbstractSchema(), null, "schemas", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComponent_Messages(), this.getAbstractMessage(), null, "messages", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
